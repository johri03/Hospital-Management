                ...
                if (fnames.equals("") || lnames.equals("") || ages.equals("") || dds.equals("") ||
                    ...
                    if (y.moveToFirst()) {
                        ...
                        if (b)
                        {
                            ...
                            /*mref.child("users").push().child("id").setValue(unames);
                            mref.child("users").push().child("password").setValue(passwords);
                            */

                            Map mParent = new HashMap();
                            mParent.put("id", unames);
                            mParent.put("phoneno", mobnos);
                            mParent.put("password", passwords);
                            mParent.put("fname", fnames);
                            mParent.put("lname", lnames);
                            mParent.put("age", ages);
                            mParent.put("Gender", sexs);
                            mParent.put("bloodgroup", bgroups);
                            mParent.put("month", mms);
                            mParent.put("utype", utypes);
                            mParent.put("city", citys);
                            mParent.put("pincode", pincodes);
                            mParent.put("year", yys);
                            mParent.put("birthdate", dds);
                            mref.child("users").push().setValue(mParent);
